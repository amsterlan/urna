   ...
   if(candidato.length > 0) {
    ...
    for(let i in candidato.fotos) {
        if(candidato.fotos[i].small){
            fotosHtml += `<div class="d-1-img small"> <img src="img/${candidato.fotos[i].url}" alt=""/>${candidato.name}</div>`;
        }else{
          fotosHtml += `<div class="d-1-img"> <img src="img/${candidato.fotos[i].url}" alt=""/>${candidato.name}</div>`;   
        }
